...
<script lang="ts">
  ...
  import { AvailableHelpSections, currentHelpSectionEvent } from './Help'

  let currentHelpSectionDisplayed: AvailableHelpSections = $state(undefined)
  let displayHelp = $state(false)
  let top, left: string
...
{#if displayHelp && currentHelpSectionDisplayed}
  <div class="help-container">
    <div class="header">
      ...
      <span
        ...
        onclick={() => {
          currentHelpSectionDisplayed = undefined
        }}
        >close
      </span>
