<script lang="ts">
  ...
  import { ByteDisplay, ByteRadix, ByteRadixDisplays, createViewportConfig, ViewportDisplayConfig, ViewportDisplayContent } from './ViewportDisplay'
  ...
  const dataDisplay = new ViewportDisplay({byteDisplay: ByteRadixDisplays['16'], bytesPerLine: 16, lineCount: 16})
