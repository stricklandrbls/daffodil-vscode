...
<html lang="en">
    <head>
        ...
        -->
        <meta http-equiv="Content-Security-Policy" content="default-src 'self'; font-src ${webView.cspSource}; style-src ${webView.cspSource}; img-src ${webView.cspSource}; script-src 'nonce-${nonce}';">
