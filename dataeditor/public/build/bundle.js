...
svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.mark_module_start();
App[svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.FILENAME] = 'src/App.svelte';




var root = svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.add_locations(svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.template(`<main class="svelte-1tky8bj"><!> <h1 class="svelte-1tky8bj"> </h1> <p>Visit the <a href="https://svelte.dev/tutorial">Svelte tutorial</a> to learn how to build Svelte apps.</p></main>`), App[svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.FILENAME], [
	[
		6,
		0,
		[[8, 1], [9, 1, [[9, 14]]]]
...
const $$css = {
	hash: 'svelte-1tky8bj',
	code: '\n	main.svelte-1tky8bj {\n		text-align: center;\n		padding: 1em;\n		max-width: 240px;\n		margin: 0 auto;\n	}\n\n	h1.svelte-1tky8bj {\n		color: #ff3e00;\n		text-transform: uppercase;\n		font-size: 4em;\n		font-weight: 100;\n	}\n\n	@media (min-width: 640px) {\n		main.svelte-1tky8bj {\n			max-width: none;\n		}\n	}\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */'
};

function App($$anchor, $$props) {
	svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.check_target(new.target);
	svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.push($$props, false, App);
	...
	var main = root();
	var node = svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.child(main);

	(0,_components_Button_svelte__WEBPACK_IMPORTED_MODULE_3__["default"])(node, { name: 'Test', disableIf: true });

	var h1 = svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.sibling(node, 2);
	...
	return svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.pop({ ...svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.legacy_api() });
}

svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.mark_module_end(App);
...
svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.mark_module_start();
Button[svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.FILENAME] = 'src/components/Button.svelte';



var root = svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.add_locations(svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.template(`<button> </button>`), Button[svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.FILENAME], [[5, 0]]);

function Button($$anchor, $$props) {
	svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.check_target(new.target);
	svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.push($$props, false, Button);

	let disableIf = svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.prop($$props, 'disableIf', 8, false);
	let name = svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.prop($$props, 'name', 8);
	var button = root();
	var text = svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.child(button, true);

	svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.reset(button);

	svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.template_effect(() => {
		button.disabled = disableIf();
		svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.set_text(text, name());
	});

	svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.append($$anchor, button);
	return svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.pop({ ...svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.legacy_api() });
}

svelte_internal_client__WEBPACK_IMPORTED_MODULE_2__.mark_module_end(Button);
